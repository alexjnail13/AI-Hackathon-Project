...
<body>
    ...
    <script>
        ...
        function loadQuestion() {
            ...
            const question = questionsArray[currentQuestion - 1] || "Question not available";
        ...
        function submitAnswer() {
            ...
            const questionsArray = sampleQuestions[candidateData.interviewType] || sampleQuestions.general;
            responses.push({
                question: questionsArray[currentQuestion - 1] || "Question not available",
                answer: answer,
        ...
        function showFeedback() {
            ...
            const answer = lastResponse ? lastResponse.answer : "";
